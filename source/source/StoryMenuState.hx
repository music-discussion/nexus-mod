...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		txtWeekTitle = new FlxText(50, 10, 0, "", 32);
		...
		var sideMenu:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('MenuThings/story/menuSide'));
		sideMenu.antialiasing = ClientPrefs.globalAntialiasing;
		sideMenu.x = 5;
		sideMenu.scale.set(1.2, 1.2);
		sideMenu.screenCenter(Y);

		var weekOneBG:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('MenuThings/story/week1_bg'));
		weekOneBG.antialiasing = ClientPrefs.globalAntialiasing;
		weekOneBG.screenCenter();
		weekOneBG.scale.set(1.5, 1.5);
		weekOneBG.x += 100;
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			weekThing.y += ((weekThing.height + 2000) * i);
			weekThing.targetY = i;
		...
		leftArrow = new FlxSprite(10 + grpWeekText.members[0].width + 10, 400);
