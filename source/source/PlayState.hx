...
class PlayState extends MusicBeatState
{
	...
	public static var shownRatings:Array<FlxText> = [];
	public static var showingRatings:Array<Bool> = [false, false, false, false];
	...
	override public function create()
	{
		...
		goodsTxt = new FlxText(12, sicksTxt.y - 64, FlxG.width, "Goods: "+ goods, 20);
		badsTxt = new FlxText(12, sicksTxt.y - 44, FlxG.width, "Bads: " + bads, 20);
		shitsTxt = new FlxText(12, sicksTxt.y - 24, FlxG.width, "Misses: "+ songMisses, 20);
  ...
  public function clearShaderFromCamera(cam:String){
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			//scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Rating: ' + ratingName; //if its ?, you most likely haven't done anything.
			scoreTxt.text = '';
		} else {
			scoreTxt.text = (songScore > 0 ? 'Score: ' + songScore : '') + (songMisses > 0 ? ' | Misses: ' + songMisses : ' | Misses : 0 (FULL COMBO)') + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;//peeps wanted no integer rating
		}
